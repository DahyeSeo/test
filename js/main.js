$(function(){
	...
	function mobileLink(){
		if(isMobile){
			$("#project1 .overview_area .link a").attr({href: "project1/mobile/index.html"});
			$("#project2 .overview_area .link a").attr({href: "project2/index.html"});
		}
		else{
			$("#project1 .overview_area .link a").attr({href: "project1/pc/index.html"});
			$("#project2 .overview_area .link a").attr({href: "project2/index.html"});
		}
	}
